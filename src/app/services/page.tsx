      ...
      <div className="bg-white pt-20">
        ...
        <section className="py-12 md:py-20 relative overflow-hidden bg-[#fbfcfd]">
          ...
          <div className="container mx-auto px-6 md:px-12 relative z-10">
            <div className="max-w-[95%] mx-auto flex flex-col lg:flex-row-reverse items-center gap-16">
              ...
              <div className="lg:w-1/2 flex flex-col items-start">
                ...
                <motion.button
                  ...
                  viewport={{ once: false, amount: 0.15 }}
                  transition={{ duration: 0.16, delay: 0.04, type: "spring", bounce: 0.1 }}
                  className="px-8 py-3 bg-gradient-to-r from-zinc-950 to-[#1e3a8a] text-white font-bold rounded-full hover:shadow-[0_10px_25px_rgba(30,58,138,0.25)] hover:scale-105 transition-all duration-300 text-sm mb-12 uppercase tracking-wider"
                >
                  Learn More
                </motion.button>
              </div>
