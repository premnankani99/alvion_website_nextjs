...
for (const dir of directories) {
    ...
    if (fs.existsSync(filePath)) {
        ...
        // Decrease left padding to move points a little back to the left
        content = content.replace(
            /className="list-disc list-inside pl-4 md:pl-12 space-y-3 text-zinc-600 text-\[15px\] md:text-base mt-3 marker:text-blue-500"/g, 
            'className="list-disc list-inside pl-2 md:pl-6 space-y-3 text-zinc-600 text-[15px] md:text-base mt-3 marker:text-blue-500"'
        );
